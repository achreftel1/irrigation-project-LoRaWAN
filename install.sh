...
sudo -u postgres psql -c "create role chirpstack_as with login password 'application';"
sudo -u postgres psql -c "create role chirpstack_ns with login password 'network';"
